...
class amount(models.Model):
    total_purchase_price = models.DecimalField(max_digits=10, decimal_places=2, null= True)

class Wallet(models.Model):
    user = models.OneToOneField(max_length=200, null = True) 
    balance = models.DecimalField(max_digits=10, decimal_places=2, default=0)
...
class Sell(models.Model):
    user = models.OneToOneField(max_length=200, null = True)
    name = models.CharField(max_length=200, null = True)
    total_selling_amount = models.DecimalField(max_digits=10, decimal_places=2)
